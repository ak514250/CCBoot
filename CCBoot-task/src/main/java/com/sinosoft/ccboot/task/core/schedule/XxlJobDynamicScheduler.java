package com.sinosoft.ccboot.task.core.schedule;

import com.sinosoft.ccboot.task.core.jobbean.RemoteHttpJobBean;
import com.sinosoft.ccboot.task.core.model.XxlJobInfo;
import com.sinosoft.ccboot.task.core.thread.JobFailMonitorHelper;
import com.sinosoft.ccboot.task.core.thread.JobRegistryMonitorHelper;
...
import com.sinosoft.ccboot.task.dao.XxlJobRegistryDao;
...
public final class XxlJobDynamicScheduler implements ApplicationContextAware {
	...
	public static boolean addJob(String jobName, String jobGroup, String cronExpression) throws SchedulerException {
        ...
        if (checkExists(jobName, jobGroup)) {
            logger.info(">>>>>>>>> addJob fail, templates.job already exist, jobGroup:{}, jobName:{}", jobGroup, jobName);
            return false;
        }
	...
	public static boolean rescheduleJob(String jobGroup, String jobName, String cronExpression) throws SchedulerException {
    	...
    	// TriggerKey valid if_exists
        if (!checkExists(jobName, jobGroup)) {
        	logger.info(">>>>>>>>>>> rescheduleJob fail, templates.job not exists, JobGroup:{}, JobName:{}", jobGroup, jobName);
            return false;
        }
