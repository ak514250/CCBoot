...
public class AdminBizImpl implements AdminBiz {
    ...
    private ReturnT<String> callback(HandleCallbackParam handleCallbackParam) {
        ...
        if (log.getHandleCode() > 0) {
            return new ReturnT<String>(ReturnT.FAIL_CODE, "log repeate callback.");     // avoid repeat callback, trigger child templates.job etc
        }

        // trigger success, to trigger child templates.job
